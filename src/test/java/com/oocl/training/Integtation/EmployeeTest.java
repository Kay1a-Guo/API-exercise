...
public class EmployeeTest {
    ...
    public void setUp() {
        ...
        employeeRepository.addEmployee(new Employees(1, "John Smith", 32, "MALE", 5000.0));
        employeeRepository.addEmployee(new Employees(2, "Jane Johnson", 28, "FEMALE", 6000.0));
        employeeRepository.addEmployee(new Employees(3, "David Williams", 35, "MALE", 5500.0));
        employeeRepository.addEmployee(new Employees(4, "Emily Brown", 23, "FEMALE", 4500.0));
        employeeRepository.addEmployee(new Employees(5, "Michael Jones", 40, "MALE", 7000.0));
    }
    @Test
    public void should_return_employees_when_get_all_employees_exist() throws Exception {
        //Given
        List<Employees> givenEmployees = employeeRepository.getAllEmployees();
        //When
    ...
    public void should_return_employees_when_get_employees_by_id() throws Exception {
        //Given
        Employees givenEmployees = employeeRepository.getEmployeeById(1);
        //When
    ...
    public void should_return_employees_when_get_employees_by_page() throws Exception {
        //Given
        List<Employees> givenEmployees = employeeRepository.getEmployeesByPage(1, 2);
        //When
    ...
    public void should_return_employees_when_get_employees_by_gender() throws Exception {
        //Given
        List<Employees> givenEmployees = employeeRepository.getEmployeesByGender("MALE");
        //When
    ...
    public void should_return_employee_when_add_employees_successful() throws Exception {
        //Given
        Employees givenEmployees = employeeRepository.addEmployee(new Employees(6, "Nick Jones", 30, "MALE", 10000.0));
        //When
    ...
    public void should_throw_exception_when_add_employees_failed() throws Exception {
        //Given
        Employees givenEmployees = employeeRepository.addEmployee(new Employees(6, "Nick Jones", 50, "MALE", 10000.0));
        //When
        ResultActions perform = mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/employees")
                .contentType("application/json")
    ...
    public void should_put_employees_successful() throws Exception {
        ...
        employeeRepository.updateEmployee(2, updateEmployeeMessage);
        //When
